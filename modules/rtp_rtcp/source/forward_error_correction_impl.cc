...
ForwardErrorCorrectionImpl::Packet::Packet() : data(0), ref_count_(0) {}
ForwardErrorCorrectionImpl::Packet::~Packet() = default;

int32_t ForwardErrorCorrectionImpl::Packet::AddRef() {
  return ++ref_count_;
}

int32_t ForwardErrorCorrectionImpl::Packet::Release() {
  int32_t ref_count;
...
bool ForwardErrorCorrectionImpl::SortablePacket::LessThan::operator()(
    const S& first,
    const T& second) {
...
ForwardErrorCorrectionImpl::ReceivedPacket::ReceivedPacket() = default;
ForwardErrorCorrectionImpl::ReceivedPacket::~ReceivedPacket() = default;

ForwardErrorCorrectionImpl::RecoveredPacket::RecoveredPacket() = default;
ForwardErrorCorrectionImpl::RecoveredPacket::~RecoveredPacket() = default;

ForwardErrorCorrectionImpl::ProtectedPacket::ProtectedPacket() = default;
ForwardErrorCorrectionImpl::ProtectedPacket::~ProtectedPacket() = default;

ForwardErrorCorrectionImpl::ReceivedFecPacket::ReceivedFecPacket() = default;
ForwardErrorCorrectionImpl::ReceivedFecPacket::~ReceivedFecPacket() = default;

ForwardErrorCorrectionImpl::ForwardErrorCorrectionImpl(
    uint32_t ssrc,
    ...
    : ssrc_(ssrc),
      ...
      packet_mask_size_(0) {
    if (ulp) {
      fec_header_reader_ = std::unique_ptr<FecHeaderReader>(new UlpfecHeaderReader());
      fec_header_writer_ = std::unique_ptr<FecHeaderWriter>(new UlpfecHeaderWriter());
    } else {
      fec_header_reader_ = std::unique_ptr<FecHeaderReader>(new FlexfecHeaderReader());
      fec_header_writer_ = std::unique_ptr<FecHeaderWriter>(new FlexfecHeaderWriter());
    }
    generated_fec_packets_ = std::vector<Packet>(fec_header_writer_->MaxFecPackets());
}
...
ForwardErrorCorrectionImpl::~ForwardErrorCorrectionImpl() = default;

std::unique_ptr<ForwardErrorCorrectionImpl> ForwardErrorCorrectionImpl::CreateUlpfec(
    uint32_t ssrc) {
  ...
  return std::unique_ptr<ForwardErrorCorrectionImpl>(new ForwardErrorCorrectionImpl(
      std::move(fec_header_reader), std::move(fec_header_writer), ssrc, ssrc));
}

std::unique_ptr<ForwardErrorCorrectionImpl> ForwardErrorCorrectionImpl::CreateFlexfec(
    uint32_t ssrc,
    uint32_t protected_media_ssrc) {
...
int ForwardErrorCorrectionImpl::EncodeFec(const PacketList& media_packets,
...
int ForwardErrorCorrectionImpl::NumFecPackets(int num_media_packets,
...
void ForwardErrorCorrectionImpl::GenerateFecPayloads(
...
int ForwardErrorCorrectionImpl::InsertZerosInPacketMasks(
    const PacketList& media_packets,
    size_t num_fec_packets) {
...
void ForwardErrorCorrectionImpl::FinalizeFecHeaders(size_t num_fec_packets,
                                                uint32_t media_ssrc,
...
void ForwardErrorCorrectionImpl::ResetState(
...
void ForwardErrorCorrectionImpl::InsertMediaPacket(
    RecoveredPacketList* recovered_packets,
...
void ForwardErrorCorrectionImpl::UpdateCoveringFecPackets(
...
void ForwardErrorCorrectionImpl::InsertFecPacket(
...
void ForwardErrorCorrectionImpl::AssignRecoveredPackets(
    const RecoveredPacketList& recovered_packets,
...
void ForwardErrorCorrectionImpl::InsertPacket(
    const ReceivedPacket& received_packet,
    RecoveredPacketList* recovered_packets) {
...
bool ForwardErrorCorrectionImpl::StartPacketRecovery(
...
bool ForwardErrorCorrectionImpl::FinishPacketRecovery(
    const ReceivedFecPacket& fec_packet,
    RecoveredPacket* recovered_packet) {
...
void ForwardErrorCorrectionImpl::XorHeaders(const Packet& src, Packet* dst) {
...
void ForwardErrorCorrectionImpl::XorPayloads(const Packet& src,
...
bool ForwardErrorCorrectionImpl::RecoverPacket(const ReceivedFecPacket& fec_packet,
                                           RecoveredPacket* recovered_packet) {
...
void ForwardErrorCorrectionImpl::AttemptRecovery(
    RecoveredPacketList* recovered_packets) {
...
int ForwardErrorCorrectionImpl::NumCoveredPacketsMissing(
    const ReceivedFecPacket& fec_packet) {
...
void ForwardErrorCorrectionImpl::DiscardOldRecoveredPackets(
    RecoveredPacketList* recovered_packets) {
...
bool ForwardErrorCorrectionImpl::IsOldFecPacket(
    const ReceivedFecPacket& fec_packet,
    const RecoveredPacketList* recovered_packets) {
...
uint16_t ForwardErrorCorrectionImpl::ParseSequenceNumber(const uint8_t* packet) {
  return (packet[2] << 8) + packet[3];
}

uint32_t ForwardErrorCorrectionImpl::ParseSsrc(const uint8_t* packet) {
  return (packet[8] << 24) + (packet[9] << 16) + (packet[10] << 8) + packet[11];
}

void ForwardErrorCorrectionImpl::DecodeFec(const ReceivedPacket& received_packet,
                                       RecoveredPacketList* recovered_packets) {
...
size_t ForwardErrorCorrectionImpl::MaxPacketOverhead() const {
